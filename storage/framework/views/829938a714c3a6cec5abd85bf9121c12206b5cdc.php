                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if(!empty($notification->user)): ?>
                                            ...
                                            <span class="font-12 d-block">ID: <?php echo e($notification->user->id); ?></span>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u276671220/domains/quadque.digital/public_html/lms/resources/views/admin/notifications/posted.blade.php ENDPATH**/ ?>