                    ...
                    <div class="card">
                        <div class="card-header">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_specifications_create')): ?>
                                <a href="<?php echo e(getAdminPanelUrl()); ?>/store/specifications/create" class="btn btn-primary"><?php echo e(trans('admin/main.add_new')); ?></a>
                            <?php endif; ?>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_specifications_edit')): ?>
                                                    <a href="<?php echo e(getAdminPanelUrl()); ?>/store/specifications/<?php echo e($specification->id); ?>/edit"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_specifications_delete')): ?>
                                                    <?php echo $__env->make('admin.includes.delete_button',['url' => getAdminPanelUrl().'/store/specifications/'.$specification->id.'/delete'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u276671220/domains/quadque.digital/public_html/lms/resources/views/admin/store/specifications/lists.blade.php ENDPATH**/ ?>